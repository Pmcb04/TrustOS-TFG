...
public class RolConfEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public RolConfEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TraceabilityMM.diagram.edit.policies.RolConfItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new RolConfFigure();
	}

	/**
	* @generated
	*/
	public RolConfFigure getPrimaryShape() {
		return (RolConfFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TraceabilityMM.diagram.edit.parts.RolConfRolConfPropertiesCompartmentEditPart) {
			...
			pane.add(((TraceabilityMM.diagram.edit.parts.RolConfRolConfPropertiesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	*/
	 ...
	 * @generated
	 */
	public class RolConfFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		public RectangleFigure getRolConfPropertiesCompartmentFigure() {
			return fRolConfPropertiesCompartmentFigure;
		}
