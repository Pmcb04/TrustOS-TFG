 ...
 * @generated
 */
public class TransactionSubtransactionReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public TransactionSubtransactionReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return TraceabilityMM.diagram.edit.policies.TraceabilityMMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTransactionSubtransaction_4009(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return TraceabilityMM.diagram.edit.policies.TraceabilityMMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTransactionSubtransaction_4009(getOldSource(), getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getSubtransaction().remove(getOldTarget());
		getNewSource().getSubtransaction().add(getOldTarget());
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getSubtransaction().remove(getOldTarget());
		getOldSource().getSubtransaction().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
