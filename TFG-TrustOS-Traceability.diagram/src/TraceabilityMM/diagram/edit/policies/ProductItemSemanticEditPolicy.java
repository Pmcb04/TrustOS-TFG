...
public class ProductItemSemanticEditPolicy
	...
	*/
	public ProductItemSemanticEditPolicy() {
		super(TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.Product_2010);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
					.getVisualID(incomingLink) == TraceabilityMM.diagram.edit.parts.TransactionNextEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry.getVisualID(
					outgoingLink) == TraceabilityMM.diagram.edit.parts.ProductProductconfEditPart.VISUAL_ID) {
			...
			if (TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
					.getVisualID(outgoingLink) == TraceabilityMM.diagram.edit.parts.ProductNextEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.ProductProductconf_4008 == req
				.getElementType()) {
			return getGEFWrapper(new TraceabilityMM.diagram.edit.commands.ProductProductconfCreateCommand(req,
	...
	protected Command getReorientReferenceRelationshipCommand(ReorientReferenceRelationshipRequest req) {
		...
		case TraceabilityMM.diagram.edit.parts.ProductProductconfEditPart.VISUAL_ID:
			return getGEFWrapper(new TraceabilityMM.diagram.edit.commands.ProductProductconfReorientCommand(req));
