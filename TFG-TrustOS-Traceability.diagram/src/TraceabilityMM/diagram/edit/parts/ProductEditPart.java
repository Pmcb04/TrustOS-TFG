...
public class ProductEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TraceabilityMM.diagram.edit.policies.ProductItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TraceabilityMM.diagram.edit.parts.ProductNameEditPart) {
			((TraceabilityMM.diagram.edit.parts.ProductNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureProductLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	 ...
	 * @generated
	 */
	public class ProductFigure extends SVGFigure {
		...
		public ProductFigure() {
			this.setURI("platform:/plugin/TFG-TrustOS-Traceability/icons/SVG/product.svg");
