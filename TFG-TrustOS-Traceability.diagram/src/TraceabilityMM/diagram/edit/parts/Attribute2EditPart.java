...
public class Attribute2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TraceabilityMM.diagram.edit.parts.AttributeName2EditPart) {
			((TraceabilityMM.diagram.edit.parts.AttributeName2EditPart) childEditPart)
	...
	*/
	...
	public class AttributeFigure extends SVGFigure {
		...
		public AttributeFigure() {
			this.setURI("platform:/plugin/TFG-TrustOS-Traceability/icons/SVG/attribute.svg");
