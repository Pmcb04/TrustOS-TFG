 ...
 * @generated
 */
public class AttributeAttributeValuesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<TraceabilityMM.diagram.part.TraceabilityMMNodeDescriptor> childDescriptors = TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater
				.getAttributeAttributeValuesCompartment_7006SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<TraceabilityMM.diagram.part.TraceabilityMMNodeDescriptor> childDescriptors = TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater
				.getAttributeAttributeValuesCompartment_7006SemanticChildren((View) getHost().getModel());
