 ...
 * @generated
 */
public class TraceabilityMMValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = TraceabilityMM.diagram.part.TraceabilityMMDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed)
					.getEditorPart() instanceof TraceabilityMM.diagram.part.TraceabilityMMDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && TraceabilityMM.diagram.edit.parts.SystemEditPart.MODEL_ID
