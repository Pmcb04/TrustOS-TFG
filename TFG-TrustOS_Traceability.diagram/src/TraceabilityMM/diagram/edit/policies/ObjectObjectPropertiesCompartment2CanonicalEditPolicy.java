 ...
 * @generated
 */
public class ObjectObjectPropertiesCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return TraceabilityMM.TraceabilityMMPackage.eINSTANCE.getObject_Properties();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<TraceabilityMM.diagram.part.TraceabilityMMNodeDescriptor> childDescriptors = TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater
				.getObjectObjectPropertiesCompartment_7005SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == TraceabilityMM.diagram.edit.parts.Attribute2EditPart.VISUAL_ID
				|| visualID == TraceabilityMM.diagram.edit.parts.Object2EditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<TraceabilityMM.diagram.part.TraceabilityMMNodeDescriptor> childDescriptors = TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater
				.getObjectObjectPropertiesCompartment_7005SemanticChildren((View) getHost().getModel());
