 ...
 * @model annotation="gmf.node label='type' label.placement='external' border.width='0' border.color='220,31,31' border.style='solid' svg.uri='platform:/plugin/TFG-TrustOS_Traceability/icons/SVG/rolConf.svg' tool.name='Rol Configuration' tool.description='Create a configuration for rol'"
