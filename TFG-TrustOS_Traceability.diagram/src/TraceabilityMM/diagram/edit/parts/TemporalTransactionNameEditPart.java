 ...
 * @generated
 */
public class TemporalTransactionNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
				.getType(TraceabilityMM.diagram.edit.parts.TemporalTransactionNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public TemporalTransactionNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new TemporalTransactionLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TemporalTransactionLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TemporalTransactionLabelFigure() {
			this.setText("TemporalTransaction");
		}
