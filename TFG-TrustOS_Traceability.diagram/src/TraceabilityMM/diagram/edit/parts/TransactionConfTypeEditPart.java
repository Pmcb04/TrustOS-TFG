 ...
 * @generated
 */
public class TransactionConfTypeEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
				.getType(TraceabilityMM.diagram.edit.parts.TransactionConfTypeEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public TransactionConfTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TraceabilityMM.diagram.providers.TraceabilityMMParserProvider.getParser(
					TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.TransactionConf_2003,
					getParserElement(), TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					TraceabilityMM.diagram.edit.parts.TraceabilityMMEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new TransactionConfLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TransactionConfLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TransactionConfLabelFigure() {
			this.setText("TransactionConf");
