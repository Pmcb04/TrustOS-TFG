...
import { getAssetTraceability, getAssetRangeTraceability, getAssetTraceabilityBefore, exportTraceabilityComplete} from '../../modules/asset-traceability/asset-traceability-screen.sagas'
...
export default function* root() {
  yield all([
    ...
    takeLatest(AssetTraceabilityTypes.ASSET_TRACEABILITY_EXPORT, exportTraceabilityComplete, api),
