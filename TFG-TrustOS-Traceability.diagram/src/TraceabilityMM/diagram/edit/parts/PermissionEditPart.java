...
public class PermissionEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TraceabilityMM.diagram.edit.policies.PermissionItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new PermissionFigure();
	}
	...
	*/
	public PermissionFigure getPrimaryShape() {
		return (PermissionFigure) primaryShape;
	}
	...
	*/
	 ...
	 * @generated
	 */
	public class PermissionFigure extends SVGFigure {
		...
		public PermissionFigure() {
			this.setURI("platform:/plugin/TFG-TrustOS-Traceability/icons/SVG/permission.svg");
