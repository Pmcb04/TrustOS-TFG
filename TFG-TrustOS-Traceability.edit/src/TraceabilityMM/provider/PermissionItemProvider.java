...
/**
 * This is the item provider adapter for a {@link TraceabilityMM.Permission} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Permission_property_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Permission_property_feature", "_UI_Permission_type"),
				 TraceabilityMMPackage.Literals.PERMISSION__PROPERTY,
				 true,
				 false,
				 true,
				 null,
