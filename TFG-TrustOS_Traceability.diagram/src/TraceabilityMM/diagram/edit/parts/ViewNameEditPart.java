 ...
 * @generated
 */
public class ViewNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
				.getType(TraceabilityMM.diagram.edit.parts.ViewNameEditPart.VISUAL_ID), new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TraceabilityMM.diagram.providers.TraceabilityMMParserProvider.getParser(
					TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.View_2012, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new ViewLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ViewLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ViewLabelFigure() {
			this.setText("View");
		}
