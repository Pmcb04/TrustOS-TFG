 ...
 * @generated
 */
public class PermissionPropertyReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public PermissionPropertyReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return TraceabilityMM.diagram.edit.policies.TraceabilityMMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistPermissionProperty_4006(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return TraceabilityMM.diagram.edit.policies.TraceabilityMMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistPermissionProperty_4006(getOldSource(), getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getProperty().remove(getOldTarget());
		getNewSource().getProperty().add(getOldTarget());
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getProperty().remove(getOldTarget());
		getOldSource().getProperty().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
