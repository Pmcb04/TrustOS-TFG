 ...
 * @generated
 */
public class TransactionNext_productReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public TransactionNext_productReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return TraceabilityMM.diagram.edit.policies.TraceabilityMMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTransactionNext_product_4002(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return TraceabilityMM.diagram.edit.policies.TraceabilityMMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTransactionNext_product_4002(getOldSource(), getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getNext_product().remove(getOldTarget());
		getNewSource().getNext_product().add(getOldTarget());
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getNext_product().remove(getOldTarget());
		getOldSource().getNext_product().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
