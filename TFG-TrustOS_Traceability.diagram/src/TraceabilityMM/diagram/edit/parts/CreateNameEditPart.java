 ...
 * @generated
 */
public class CreateNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
				.getType(TraceabilityMM.diagram.edit.parts.CreateNameEditPart.VISUAL_ID), new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TraceabilityMM.diagram.providers.TraceabilityMMParserProvider.getParser(
					TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.Create_2011, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new CreateLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CreateLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CreateLabelFigure() {
			this.setText("Create");
		}
