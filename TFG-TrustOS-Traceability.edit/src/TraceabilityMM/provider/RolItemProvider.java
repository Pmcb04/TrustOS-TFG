...
/**
 * This is the item provider adapter for a {@link TraceabilityMM.Rol} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RolItemProvider extends AssetItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rol_permissions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rol_permissions_feature", "_UI_Rol_type"),
				 TraceabilityMMPackage.Literals.ROL__PERMISSIONS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TraceabilityMMPackage.Literals.ROL__ACCESS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Rol)object).getAssetID();
