...
public class SystemItemSemanticEditPolicy
	...
	*/
	protected Command getCreateCommand(CreateElementRequest req) {
		if (TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.Rol_2001 == req.getElementType()) {
			return getGEFWrapper(new TraceabilityMM.diagram.edit.commands.RolCreateCommand(req));
		}
		if (TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.TransactionConf_2002 == req.getElementType()) {
			return getGEFWrapper(new TraceabilityMM.diagram.edit.commands.TransactionConfCreateCommand(req));
		}
		if (TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.ProductConf_2003 == req.getElementType()) {
			return getGEFWrapper(new TraceabilityMM.diagram.edit.commands.ProductConfCreateCommand(req));
		}
		if (TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.View_2004 == req.getElementType()) {
			return getGEFWrapper(new TraceabilityMM.diagram.edit.commands.ViewCreateCommand(req));
		}
		if (TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.Create_2005 == req.getElementType()) {
			return getGEFWrapper(new TraceabilityMM.diagram.edit.commands.CreateCreateCommand(req));
		}
		if (TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.Edit_2006 == req.getElementType()) {
			return getGEFWrapper(new TraceabilityMM.diagram.edit.commands.EditCreateCommand(req));
		}
		if (TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.Transaction_2007 == req.getElementType()) {
			return getGEFWrapper(new TraceabilityMM.diagram.edit.commands.TransactionCreateCommand(req));
		}
		if (TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.Product_2010 == req.getElementType()) {
			return getGEFWrapper(new TraceabilityMM.diagram.edit.commands.ProductCreateCommand(req));
		}
		if (TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.Permission_2009 == req.getElementType()) {
