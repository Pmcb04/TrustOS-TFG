	...
	*/
	private Collection<TraceabilityMM.diagram.part.TraceabilityMMLinkDescriptor> collectAllLinks(View view,
		...
		case TraceabilityMM.diagram.edit.parts.TransactionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater
						.getTransaction_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case TraceabilityMM.diagram.edit.parts.ProductEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater.getProduct_2002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case TraceabilityMM.diagram.edit.parts.TransactionConfEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater
						.getTransactionConf_2003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case TraceabilityMM.diagram.edit.parts.ProductConfEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater
						.getProductConf_2004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case TraceabilityMM.diagram.edit.parts.RolConfEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater.getRolConf_2014ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case TraceabilityMM.diagram.edit.parts.EditEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater.getEdit_2010ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case TraceabilityMM.diagram.edit.parts.CreateEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater.getCreate_2011ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case TraceabilityMM.diagram.edit.parts.ViewEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater.getView_2012ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case TraceabilityMM.diagram.edit.parts.PermissionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater
						.getPermission_2013ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case TraceabilityMM.diagram.edit.parts.ValueEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater.getValue_3005ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
