 ...
 * @generated
 */
public class ProductNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
				.getType(TraceabilityMM.diagram.edit.parts.ProductNameEditPart.VISUAL_ID), new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TraceabilityMM.diagram.providers.TraceabilityMMParserProvider.getParser(
					TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.Product_2002, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new ProductLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ProductLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ProductLabelFigure() {
