...
public class AttributeEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TraceabilityMM.diagram.edit.parts.AttributeNameEditPart) {
			((TraceabilityMM.diagram.edit.parts.AttributeNameEditPart) childEditPart)
