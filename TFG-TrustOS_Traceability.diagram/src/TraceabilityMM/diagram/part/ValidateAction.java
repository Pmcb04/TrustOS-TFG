...
public class ValidateAction extends Action {
	...
	*/
	public ValidateAction(IWorkbenchPage page) {
		setText(TraceabilityMM.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	*/
	public static void runValidation(View view) {
		try {
			if (TraceabilityMM.diagram.part.TraceabilityMMDiagramEditorUtil.openDiagram(view.eResource())) {
	...
	*/
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		TraceabilityMM.diagram.providers.TraceabilityMMValidationProvider.runWithConstraints(txDomain, new Runnable() {
	...
	*/
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			TraceabilityMM.diagram.providers.TraceabilityMMMarkerNavigationProvider.deleteMarkers(target);
		}
	...
	*/
	private static void createMarkers(IFile target, IStatus validationStatus, DiagramEditPart diagramEditPart) {
		...
		TraceabilityMM.diagram.part.TraceabilityMMDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new TraceabilityMM.diagram.part.TraceabilityMMDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(),
				collectTargetElements(rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = TraceabilityMM.diagram.part.TraceabilityMMDiagramEditorUtil.findView(diagramEditPart,
	...
	*/
	private static void addMarker(EditPartViewer viewer, IFile target, String elementId, String location,
		...
		TraceabilityMM.diagram.providers.TraceabilityMMMarkerNavigationProvider.addMarker(target, elementId, location,
