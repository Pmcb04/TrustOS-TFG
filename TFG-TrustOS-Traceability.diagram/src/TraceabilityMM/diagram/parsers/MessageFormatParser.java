 ...
 * 
 */
package TraceabilityMM.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(TraceabilityMM.diagram.part.TraceabilityMMDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(TraceabilityMM.diagram.part.Messages.MessageFormatParser_InvalidInputError,
