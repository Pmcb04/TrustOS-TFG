	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case TraceabilityMM.diagram.edit.parts.TransactionEditPart.VISUAL_ID: {
			...
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup outgoinglinks = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_Transaction_2001_outgoinglinks,
			...
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup incominglinks = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_Transaction_2001_incominglinks,
		...
		case TraceabilityMM.diagram.edit.parts.ProductEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup incominglinks = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_Product_2002_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup outgoinglinks = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_Product_2002_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
		...
		case TraceabilityMM.diagram.edit.parts.TransactionConfEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup incominglinks = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_TransactionConf_2003_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
		...
		case TraceabilityMM.diagram.edit.parts.ProductConfEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup incominglinks = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_ProductConf_2004_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry.getType(
		...
		case TraceabilityMM.diagram.edit.parts.EditEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup incominglinks = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_Edit_2010_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup outgoinglinks = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_Edit_2010_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
		...
		case TraceabilityMM.diagram.edit.parts.CreateEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup incominglinks = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_Create_2011_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup outgoinglinks = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_Create_2011_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
		...
		case TraceabilityMM.diagram.edit.parts.ViewEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup incominglinks = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_View_2012_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup outgoinglinks = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_View_2012_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
		...
		case TraceabilityMM.diagram.edit.parts.PermissionEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup incominglinks = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_Permission_2013_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup outgoinglinks = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_Permission_2013_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
		...
		case TraceabilityMM.diagram.edit.parts.RolConfEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup outgoinglinks = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_RolConf_2014_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry.getType(
		...
		case TraceabilityMM.diagram.edit.parts.TransactionTransactionconfEditPart.VISUAL_ID: {
			...
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup target = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_TransactionTransactionconf_4001_target,
			...
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup source = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_TransactionTransactionconf_4001_source,
		...
		case TraceabilityMM.diagram.edit.parts.TransactionNext_productEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup target = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_TransactionNext_product_4002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup source = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_TransactionNext_product_4002_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
		...
		case TraceabilityMM.diagram.edit.parts.ProductProductconfEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup target = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_ProductProductconf_4003_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup source = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_ProductProductconf_4003_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
		...
		case TraceabilityMM.diagram.edit.parts.ProductNext_transactionEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup target = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_ProductNext_transaction_4004_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup source = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
		...
		case TraceabilityMM.diagram.edit.parts.PermissionRefersEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup target = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_PermissionRefers_4005_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup source = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_PermissionRefers_4005_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
		...
		case TraceabilityMM.diagram.edit.parts.RolConfPermissionsEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup target = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_RolConfPermissions_4008_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup source = new TraceabilityMM.diagram.navigator.TraceabilityMMNavigatorGroup(
					TraceabilityMM.diagram.part.Messages.NavigatorGroupName_RolConfPermissions_4008_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
