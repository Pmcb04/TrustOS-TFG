...
/**
 * This is the item provider adapter for a {@link TraceabilityMM.Asset} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssetItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TraceabilityMMPackage.Literals.ASSET__TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TraceabilityMMPackage.Literals.ASSET__PROPERTIES);
		}
	...
	public String getText(Object object) {
		String label = ((Asset)object).getType();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Asset.class)) {
			case TraceabilityMMPackage.ASSET__TYPE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TraceabilityMMPackage.Literals.ASSET__PROPERTIES,
