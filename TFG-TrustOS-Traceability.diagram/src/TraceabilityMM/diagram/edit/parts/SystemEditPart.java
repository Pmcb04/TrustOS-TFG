...
public class SystemEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "TraceabilityMM"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TraceabilityMM.diagram.edit.policies.SystemItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new TraceabilityMM.diagram.edit.policies.SystemCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new TraceabilityMM.diagram.edit.commands.TraceabilityMMCreateShortcutDecorationsCommand(
