...
public class EditItemSemanticEditPolicy
	...
	*/
	public EditItemSemanticEditPolicy() {
		super(TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.Edit_2006);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
					.getVisualID(incomingLink) == TraceabilityMM.diagram.edit.parts.RolPermissionsEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry.getVisualID(
					outgoingLink) == TraceabilityMM.diagram.edit.parts.PermissionPropertyEditPart.VISUAL_ID) {
	...
	*/
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.PermissionProperty_4006 == req
				.getElementType()) {
			return getGEFWrapper(new TraceabilityMM.diagram.edit.commands.PermissionPropertyCreateCommand(req,
	...
	*/
	protected Command getReorientReferenceRelationshipCommand(ReorientReferenceRelationshipRequest req) {
		...
		case TraceabilityMM.diagram.edit.parts.PermissionPropertyEditPart.VISUAL_ID:
			return getGEFWrapper(new TraceabilityMM.diagram.edit.commands.PermissionPropertyReorientCommand(req));
		}
