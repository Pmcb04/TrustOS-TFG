 ...
 * @generated
 */
public class AttributeAttributeValuesCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return TraceabilityMM.TraceabilityMMPackage.eINSTANCE.getAttribute_Values();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<TraceabilityMM.diagram.part.TraceabilityMMNodeDescriptor> childDescriptors = TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater
				.getAttributeAttributeValuesCompartment_7007SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return TraceabilityMM.diagram.edit.parts.ValueEditPart.VISUAL_ID == TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
				.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<TraceabilityMM.diagram.part.TraceabilityMMNodeDescriptor> childDescriptors = TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater
				.getAttributeAttributeValuesCompartment_7007SemanticChildren((View) getHost().getModel());
