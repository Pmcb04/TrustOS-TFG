 ...
 * @generated
 */
public class TraceabilityMMMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = TraceabilityMM.diagram.part.TraceabilityMMDiagramEditorPlugin.ID
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			TraceabilityMM.diagram.part.TraceabilityMMDiagramEditorUtil.selectElementsInDiagram(editor,
