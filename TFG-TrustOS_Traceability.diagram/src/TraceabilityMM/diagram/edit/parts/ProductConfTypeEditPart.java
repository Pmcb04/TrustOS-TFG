 ...
 * @generated
 */
public class ProductConfTypeEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
				.getType(TraceabilityMM.diagram.edit.parts.ProductConfTypeEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public ProductConfTypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TraceabilityMM.diagram.providers.TraceabilityMMParserProvider.getParser(
					TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.ProductConf_2004, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new ProductConfLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ProductConfLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ProductConfLabelFigure() {
			this.setText("ProductConf");
