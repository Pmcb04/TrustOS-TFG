	...
	*/
	static {
		registerSnapBackPosition(TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry
				.getType(TraceabilityMM.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TraceabilityMM.diagram.providers.TraceabilityMMParserProvider.getParser(
					TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.RolPermissions_4004, getParserElement(),
