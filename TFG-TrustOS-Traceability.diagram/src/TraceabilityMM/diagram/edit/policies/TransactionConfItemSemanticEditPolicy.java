 ...
 * @generated
 */
public class TransactionConfItemSemanticEditPolicy
		extends TraceabilityMM.diagram.edit.policies.TraceabilityMMBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public TransactionConfItemSemanticEditPolicy() {
		super(TraceabilityMM.diagram.providers.TraceabilityMMElementTypes.TransactionConf_2002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (TraceabilityMM.diagram.part.TraceabilityMMVisualIDRegistry.getVisualID(
					incomingLink) == TraceabilityMM.diagram.edit.parts.TransactionTransactionconfEditPart.VISUAL_ID) {
