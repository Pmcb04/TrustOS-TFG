 ...
 * @generated
 */
public class TransactionConfTransactionConfPropertiesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return TraceabilityMM.TraceabilityMMPackage.eINSTANCE.getAsset_Properties();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<TraceabilityMM.diagram.part.TraceabilityMMNodeDescriptor> childDescriptors = TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater
				.getTransactionConfTransactionConfPropertiesCompartment_7002SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == TraceabilityMM.diagram.edit.parts.AttributeEditPart.VISUAL_ID
				|| visualID == TraceabilityMM.diagram.edit.parts.ObjectEditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<TraceabilityMM.diagram.part.TraceabilityMMNodeDescriptor> childDescriptors = TraceabilityMM.diagram.part.TraceabilityMMDiagramUpdater
				.getTransactionConfTransactionConfPropertiesCompartment_7002SemanticChildren(
