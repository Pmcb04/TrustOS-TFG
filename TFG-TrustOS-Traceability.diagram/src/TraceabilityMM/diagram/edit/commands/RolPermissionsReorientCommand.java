 ...
 * @generated
 */
public class RolPermissionsReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public RolPermissionsReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof TraceabilityMM.Permission && newEnd instanceof TraceabilityMM.Rol)) {
			return false;
		}
		return TraceabilityMM.diagram.edit.policies.TraceabilityMMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRolPermissions_4004(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return TraceabilityMM.diagram.edit.policies.TraceabilityMMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRolPermissions_4004(getOldSource(), getNewTarget());
	}
