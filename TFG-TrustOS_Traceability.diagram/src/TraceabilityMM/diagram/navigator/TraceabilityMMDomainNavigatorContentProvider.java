 ...
 * @generated
 */
public class TraceabilityMMDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public TraceabilityMMDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof TraceabilityMM.diagram.navigator.TraceabilityMMDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((TraceabilityMM.diagram.navigator.TraceabilityMMDomainNavigatorItem) parentElement).getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new TraceabilityMM.diagram.navigator.TraceabilityMMDomainNavigatorItem((EObject) objects[i],
